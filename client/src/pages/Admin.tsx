        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <Select value={theme} onValueChange={setTheme}>
              <SelectTrigger className="w-[180px] bg-red-800 border-red-600 text-white">
              ...
              <SelectContent>
                ...
                <SelectItem value="alianza">Alianza (Verde)</SelectItem>
              </SelectContent>
            </Select>
            <span>Bienvenido, {user?.username}</span>
            <Button variant="ghost" size="sm" onClick={() => logoutMutation.mutate()} className="text-white hover:bg-red-800">
                  ...
                  <Dialog>
                    ...
                    <DialogContent>
                      ...
                      <Form {...activityForm}><form onSubmit={activityForm.handleSubmit(data => createActivityMutation.mutate(data))} className="space-y-4">
                        ...
                        <Button type="submit" className="w-full bg-red-700" disabled={createActivityMutation.isPending}>Crear</Button>
                      </form></Form>
                    </DialogContent>
                  </Dialog>
                </CardHeader>
                  ...
                  <Dialog>
                    ...
                    <DialogContent>
                      ...
                      <Form {...newsForm}><form onSubmit={newsForm.handleSubmit(data => createNewsMutation.mutate(data))} className="space-y-4">
                        ...
                        <Button type="submit" className="w-full bg-red-700" disabled={createNewsMutation.isPending}>Publicar</Button>
                      </form></Form>
                    </DialogContent>
                  </Dialog>
                </CardHeader>
                  ...
                  <Dialog>
                    ...
                    <DialogContent>
                      ...
                      <Form {...proposalForm}><form onSubmit={proposalForm.handleSubmit(data => createProposalMutation.mutate(data))} className="space-y-4">
                        ...
                        <Button type="submit" className="w-full bg-red-700" disabled={createProposalMutation.isPending}>Añadir</Button>
                      </form></Form>
                    </DialogContent>
                  </Dialog>
                </CardHeader>
                ...
                <Form {...homeForm}>
                  <form onSubmit={homeForm.handleSubmit(data => updateHomeContentMutation.mutate(data))} className="space-y-6">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Imagen Hero (Fondo)</FormLabel>
                          <FormControl>
